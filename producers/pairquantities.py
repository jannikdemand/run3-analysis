...
#     name="tau_dxy_1",
#     call="quantities::dxy({df}, {output}, 0, {input})",
#     input=[q.selectedLepton, nanoAOD.Tau_dxy],
#     output=[q.dxy_1],
#     scopes=["tt"],
# )
# tau_dxy_2 = Producer(
...
electron_convVeto_1 = Producer(
    ...
    call="quantities::nano_bool({df}, {output}, 0, {input})",
...
electron_convVeto_2 = Producer(
    ...
    call="quantities::nano_bool({df}, {output}, 1, {input})",
    input=[q.selectedLepton, nanoAOD.Electron_convVeto],
    output=[q.convVeto_2],
    scopes=["ee"],
)
...
#     name="tau_q_1",
#     call="quantities::charge({df}, {output}, 0, {input})",
#     input=[q.selectedLepton, nanoAOD.Tau_charge],
#     output=[q.q_1],
#     scopes=["tt"],
# )
# tau_q_2 = Producer(
...
#     name="tau_iso_1",
#     call="quantities::isolation({df}, {output}, 0, {input})",
#     input=[q.selectedLepton, nanoAOD.Tau_IDraw],
#     output=[q.iso_1],
#     scopes=["tt"],
# )
# tau_iso_2 = Producer(
...
#     input=[q.selectedLepton, nanoAOD.Tau_decayMode],
...
#     input=[q.selectedLepton, nanoAOD.Tau_associatedJet, nanoAOD.Jet_pt],
...
#     input=[q.selectedLepton, nanoAOD.Tau_ID_vsJet],
...
#     input=[q.selectedLepton, nanoAOD.Tau_ID_vsEle],
...
#     input=[q.selectedLepton, nanoAOD.Tau_ID_vsMu],
